...
function render(){
  ...
  html+=`<div class="mono" style="padding:8px 0 24px">sample data · figures in inr · one visualization per card · pin order: newest last · click any bar, row or cell to drill IN PLACE (breadcrumb undoes)</div>`;
